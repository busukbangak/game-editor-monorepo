...
var TransformControls = function (camera, domElement, scene, orbit) {
    ...
    // TODO: Maybe this will cause problems if not removing
    this.addEventListener('dragging-changed', function (event) {
    ...
    var mouseDownEvent = { type: "mouseDown", mode: undefined };
